...
### Changes Made
1. **hanja.js line 115**: Changed game name from '체조' to '카드 뒤집기', icon from '🤸' to '🃏'
2. **gymnastics.js line 147**: Updated return value name to '카드 뒤집기'
3. **leaderboard.js lines 7-8**:
   - Added missing games (반의어, 사자성어, 동음이의) to tabs
   - Updated gymnastics name to '카드 뒤집기'
...
7. **archery.js lines 187-189**: Updated `getResult()`:
   ...
   - Changed detail string from '10 적중' to '25 적중'
